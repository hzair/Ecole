              ...
              <div class="row backgroundRecap">
                  <div class="col-md-8 animated" data-animate="fadeInLeft">
                    <div class="wrap animated" data-animate="fadeInDown">
                        <div class="col-md-12">
                            <address>
                                <span><i class="fa fa-group fa-lg"></i> Père : Mr <?php echo($pere["nom"]." ".$pere["prenom"]);?></span>
                                <span><i class="fa fa-group fa-lg"></i>  Mère : Mme <?php echo($mere["nom"]." ".$mere["prenom"]);?></span>
                                <span><i class="fa fa-phone fa-lg"></i>  <?php echo($pere["telephone_fixe"]);?></span>
                            </address>
                        </div>
                    </div>
                  </div>
                  <div class="col-md-4 animated" data-animate="fadeInRight">
                      <address>
                          <span><i class="fa fa-map-marker fa-lg"></i> <?php echo($pere["adresse"]." ".$pere["code_postale"]." - ".$pere["ville"]);?></span>
                          <span><i class="fa fa-mobile-phone fa-lg"></i> <?php echo($pere["telephone_portable"]); ?> &nbsp; &nbsp;<i class="fa fa-mobile-phone fa-lg"></i> <?php echo($mere["telephone_portable"]);?></span>
                          <span><i class="fa fa-envelope-o fa-lg"></i> <?php echo($pere["email"]);?></span>
                      </address>
                  </div>
              </div>
                  ...
                  <div class="wrap animated" data-animate="fadeInDown">
                      ...
                      <div class="col-md-6">
                          <form action="ajouterAdultes.php#adulte">
                            <button class="btn btn-default center-block submit" href="#inscrirAdultes">Inscrir Adulte</button>
                          </form>
                      </div>
                  </div>
              </div>
